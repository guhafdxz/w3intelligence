...
with tab1:
    ...
    markets = [
        {"topic": "Bitcoin Price > $100K by Dec 2026", "platform": "Polymarket", "yes_prob": 67, "no_prob": 33, "volume": "$2.4M"},
        {"topic": "Spot Ethereum ETF Approval", "platform": "Polymarket", "yes_prob": 82, "no_prob": 18, "volume": "$1.8M"},
        {"topic": "Fed Rate Cut in June", "platform": "Metaculus", "yes_prob": 55, "no_prob": 45, "volume": "$890K"},
        {"topic": "US Presidential Election", "platform": "Polymarket", "yes_prob": 48, "no_prob": 52, "volume": "$5.2M"},
        {"topic": "Solana TVL > $5B by Q3", "platform": "Manifold", "yes_prob": 71, "no_prob": 29, "volume": "$450K"}
    ]
    st.table(markets)
    ...
    sentiment_data = [
        {"category": "Crypto", "bullish": 65, "bearish": 35},
        {"category": "DeFi", "bullish": 58, "bearish": 42},
        {"category": "RWA", "bullish": 72, "bearish": 28},
        {"category": "AI", "bullish": 78, "bearish": 22},
        {"category": "Regulation", "bullish": 45, "bearish": 55}
    ]
    ...
    st.subheader("Market Volume Trends")
    volume_trend = [
        {"week": "W1", "volume": 12},
        {"week": "W2", "volume": 15},
        {"week": "W3", "volume": 18},
    ...
    platforms = [
        {"name": "Polymarket", "volume": "$45M", "markets": 1200, "users": "250K+"},
        {"name": "Metaculus", "volume": "$8M", "markets": 800, "users": "100K+"},
        {"name": "Manifold", "volume": "$5M", "markets": 500, "users": "50K+"},
        {"name": "PredictIt", "volume": "$3M", "markets": 200, "users": "30K+"}
    ]
    st.table(platforms)
